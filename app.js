...
// I added my own "Exercise # results" to keep track of everything for myself
...
game.party.push(pokemon[73], pokemon[121], pokemon[6]);
...
game.party.forEach(pokemon => {
    console.log("Exercise 8 Results: ", pokemon.name);
});
...
pokemon.forEach(animal => {
    if (animal.starter) {
        console.log("Exercise 9 Results: ", animal.name)
    }
})
...
console.log("Exercise 11 Results: ", game.party);
console.log("Exercise 11 Results: ", game.items[1])
...
game.gymStatus = function () {
  ...
  game.gyms.forEach((gym) => {
    ...
    } else gymTally.incompleted += 1;
  });

  console.log("Exercise 13 Results: ", gymTally);
...
game.partyCount = function () {
  console.log("Exercise 14 results: ", game.party.length)
}
